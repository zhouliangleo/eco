...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        predicts.append(torch.argmax(output,dim=1).data.cpu())
    ...
    cls_recall,mean_recall=class_recall(predicts,targets)



    writer.add_scalar('data/trainloss',losses.avg,epoch)
    writer.add_scalar('data/trainacc',top1.avg,epoch)
    writer.add_scalar('data/trainrec',mean_recall,epoch)
